...
public sealed partial class BarcodeScannerViewModel : BaseViewModel
{
    ...
    /// <returns><see langword="true"/> for EAN-13 and QR codes, and for every type in extended mode; otherwise <see langword="false"/>.</returns>
    public bool IsSymbologyAllowed(BarcodeSymbology symbology)
        => applicationSettings.IsBarcodeExtendedMode
            || symbology is BarcodeSymbology.Ean13 or BarcodeSymbology.QrCode;
