...
public partial class ItemsListViewModel : PagedListViewModelBase<Item, ItemViewModel>, IDisposable
{
    ...
    protected override Task<List<Item>> LoadAsync(int pageNumber, int requestedPageSize)
        => inventoryRepository.GetAllItemsWithPhotosAsync(pageNumber, requestedPageSize);
}
